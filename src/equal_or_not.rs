    ...
    pub fn assign (
        ...
        layouter.assign_region(
            ...
            |mut region| {
                ...
                let a_cell = region.assign_advice(|| "a", self.config.a, offset, || Value::known(a))?;
                let b_cell = region.assign_advice(|| "b", self.config.b, offset, || Value::known(b))?;
                ...
                let out_cell = region.assign_advice(|| "output", self.config.output, offset, || Value::known(output))?;
